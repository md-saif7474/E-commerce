	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active"> <a class="nav-link" href="#!" data-toggle="modal" data-target="#cart"> <i class="fa fa-cart-plus" style="font-size:20px"></i> <span class="cart-items">(0)</span> </a> </li>
				...
				%>
						...
						<li class="nav-item active"><a class="nav-link" href="LogoutSevlet">LogOut</a></li>
