...
public class User {
	...
	public User(int userId, String userName, String userPhone, String userEmail, String userPassword, String userPic,
	...
	public User(String userName, String userPhone, String userEmail, String userPassword, String userPic,
			String userAddress,String userType) {
		super();
		this.userName = userName;
		this.userPhone = userPhone;
